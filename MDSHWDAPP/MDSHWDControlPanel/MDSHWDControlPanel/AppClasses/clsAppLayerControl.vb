...
#Region "Cls Function"
    ...
    Public Function ReadAppLayerINICFGFile(ByVal strAppLayerINIPath As String) As Boolean
        ...
        Try
            ...
            'APPLayer\...
            strFileINIPath = GetMainSystemPathControl() & strAppLayerINIPath.Trim
            ...
            If (File.Exists(strFileINIPath)) Then
                ...
                With udtClsAppLayerIniCFG
                    ...
                    If blnAppPathCtr = True Then
                        'Section Key - Ini File Path
                        strtmpMainAppPath = GetMainSystemPathControl()
    ...
    Public Function UpdateAppLayerINICFGFile(ByVal strAppLayerINIPath As String, ByVal udtAppLayerINIValue As ClsAppLayerIniSTR) As Boolean
        Dim strFileINIPath As String = String.Empty
        Try
