...
#Region "Default Log File Name"
    ...
    Private Const APPEVTLOGFILENAME As String = "DefaultAppEvtLog.LOG"
#End Region
...
#Region "CLS Variable"
    ...
    Private m_IniObj As FileUtils.IniFile
...
#Region "Read App Log Ini File Path"
    ...
    Public Sub LoadLogCfgSection(ByVal strIniPath As String, ByVal MDSModules As clsAppMainDirectoryControl.MDSHWD)
        ...
        Try
            ...
            If (m_IniObj Is Nothing) Then
                m_IniObj = New FileUtils.IniFile(m_strINIFullPath, False)
            End If
            ...
            If blnAppPathCtr = True Then
                ...
                strLogFolder = m_IniObj.GetStrVal(INI_LOGCFG_PATH_KEY, String.Empty)

                'Main App Folder
                strMAINPATH = GetMainSystemPathControl(MDSModules)
...
#Region "CLS Function"
    ...
    Public Function InitLogger(ByVal strIniPath As String, ByVal MDSModules As clsAppMainDirectoryControl.MDSHWD) As Boolean
        Try

            'Load Log Setting
            LoadLogCfgSection(strIniPath, MDSModules)
