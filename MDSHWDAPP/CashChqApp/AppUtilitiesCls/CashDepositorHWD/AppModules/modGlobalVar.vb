...
#Region "App Layer Default Ini File"
    'Hookup Ini File
    Public Const MDSHWDINIPATH As String = "AppIniFile\CASHHWDCFG.ini"
...
#Region "App Golbal Variable/Object "
    ...
    Public udtNoteList As MDSModuleControl.clsMDSModuleControl.TrxNoteList
    Public udtCashBoxNoteList As MDSModuleControl.clsMDSModuleControl.CashBoxCount
    Public udtChqBoxList As MDSModuleControl.clsMDSModuleControl.ChqBoxCount
