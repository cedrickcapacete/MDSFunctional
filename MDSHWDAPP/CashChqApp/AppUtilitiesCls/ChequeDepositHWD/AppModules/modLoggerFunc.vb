...
Module modLoggerFunc
    ...
    Private strTitle As String = "clsChequeHWDInterface-modLoggerFunc"
    Private strClassNm As String = "clsChequeHWDInterface"
...
#Region "Logger Control - InitLog,CloseLog"
    ...
    Public Sub InitLog(ByVal strAppLogIniPath As String)
        ...
        Try
            ...
            strLogEvt = "Log Start - clsChequeHWDInterface"
            objAppLog.AppEvtLog(LOGINFO, strLogEvt)


        Catch ex As Exception
            strErrMsg = "Error in clsChequeHWDInterface-InitLog."
    ...
    Public Sub CloseLog()
        Try
            ...
            'Logger End
            strLogEvt = "Log End - clsChequeHWDInterface"
            objAppLog.AppEvtLog(LOGINFO, strLogEvt)
...
#Region "App Log Events - Info,Warning,Error"
    ...
    Public Sub AppLogInfo(ByVal strInfoEvt As String)
        Try
            ...
            objAppLog.AppEvtLog(LOGINFO, strLogEvt)
        Catch ex As Exception
            strErrMsg = "Error in clsChequeHWDInterface-AppLogInfo."
            strErrMsg += ControlChars.NewLine & ex.Message
            MsgBox(strErrMsg, MsgBoxStyle.Critical, strTitle)
        End Try
    End Sub
    ...
    Public Sub AppLogWarn(ByVal strWarnEvt As String)
        ...
        Catch ex As Exception
            strErrMsg = "Error in clsChequeHWDInterface-AppLogWarn."
            strErrMsg += ControlChars.NewLine & ex.Message
            MsgBox(strErrMsg, MsgBoxStyle.Critical, strTitle)
        End Try
    End Sub
    ...
    Public Sub AppLogErr(ByVal strErrEvt As String)
        Try
            ...
            'MsgBox(strErrMsg, MsgBoxStyle.Critical, strTitle)
        Catch ex As Exception
            strErrMsg = "Error in clsChequeHWDInterface-AppLogErr."
            strErrMsg += ControlChars.NewLine & ex.Message
            MsgBox(strErrMsg, MsgBoxStyle.Critical, strTitle)
        End Try
    End Sub
