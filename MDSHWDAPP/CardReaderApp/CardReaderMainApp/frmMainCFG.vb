...
#Region "Support Method"
    ...
    Private Sub InitCRMainAppLog()
        ...
        Try
            ...
            If objAppLayerINI.ReadAppLayerINICFGFile(CARDREADERMAINAPPINIPATH, CARDREADER) = True Then
                ...
                'LOG INI PATH
                AppLogInfo("Card Reader Main App Init Ok")
        ...
        Catch ex As Exception
            strErrMsg = "Error in " & strTitle & ".InitCRMainAppLog:" & ex.Message
            MsgBox(strErrMsg, MsgBoxStyle.Critical, "SysError")
        End Try
...
#Region "User Command"
    ...
    Private Sub btnExit_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnExit.Click
        Try
            'Unload Me
            AppLogInfo("Card Reader Main Menu - Exit")
            Me.Close()
        Catch ex As Exception
    ...
    Private Sub btnSystemMode_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSystemMode.Click
        Try
            AppLogInfo("Card Reader System Maintenance Mode Selected")
            CardReaderMainApp.ShowDialog()
        Catch ex As Exception
    ...
    Private Sub btnDiagnostic_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnDiagnostic.Click
        Try
            AppLogInfo("Card Reader Diagnostic Mode Selected - Engineer")
