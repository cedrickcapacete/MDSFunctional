...
namespace WpfApplication1 {
    public partial class Page_EnterAccountNo : Page {
        ...
        private void Window_Loaded(object sender, RoutedEventArgs e) {
            try {
                clsGloFun.LogWrite("#ENTERACCOUNTNO PAGE", "INFO");
                clsGloVar.str_Page_Name = "ENTERACCOUNTNO_WINDOW";
                ...
                if (clsGloVar.str_TrasactionType == "DEP") {
                    lblCaption.Content = "Enter your Account Number";
                } else {
                    lblCaption.Content = "Enter Subscriber's Account No.";
                }
        ...
        private void btnEnter_Click(object sender, RoutedEventArgs e) {
            try {
                clsGloVar.str_AccountNumber = AccNo;
                clsGloFun.LogWrite("Entered Account Number: " + AccNo.Substring(AccNo.Length-4).PadLeft(12,'*') , "INFO");
                Uri uri = new Uri("Page_DisplayAccountInfo.xaml", UriKind.Relative);
        ...
        private void set_Value(string str_char) {
            try {
                ...
                if (AccNo.Length < clsGloVar.int_AccountNoLength) {
